...
type nodePingController struct {
	nodeProvider plugins.NodeProvider
...
func newNodePingController(node plugins.NodeProvider, pingInterval time.Duration, timeout *time.Duration) *nodePingController {
	if pingInterval == 0 {
