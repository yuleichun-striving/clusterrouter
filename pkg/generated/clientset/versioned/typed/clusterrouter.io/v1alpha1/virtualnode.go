...
import (
	...
	scheme "github.com/clusterrouter-io/clusterrouter/pkg/generated/clientset/versioned/scheme"
...
type VirtualNodesGetter interface {
	VirtualNodes() VirtualNodeInterface
}
...
func newVirtualNodes(c *ClusterrouterV1alpha1Client) *virtualNodes {
	return &virtualNodes{
		client: c.RESTClient(),
	}
}
